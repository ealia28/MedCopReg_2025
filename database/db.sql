CREATE TABLE app_patient (
    ...
    patient_email_address VARCHAR(100) NULL,
    patient_phone_number VARCHAR(20) NULL,
    patient_created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE app_doctor (
    ...
    doctor_specialty_text VARCHAR(100) NULL,
    doctor_license_number VARCHAR(50) NULL,
...
CREATE TABLE app_medicine (
    ...
    medicine_dosage_text VARCHAR(100) NULL,
    medicine_manufacturer_name VARCHAR(150) NULL,
...
CREATE TABLE app_appointment (
    ...
    appointment_status_code VARCHAR(20) DEFAULT 'completed',
    appointment_follow_up_date DATE NULL,
